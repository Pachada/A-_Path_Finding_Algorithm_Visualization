...
RED = (255, 0, 0)       #closes, already visited
GREEN = (0, 255, 0)     #Open,
BLUE = (0, 255, 0)
YELLOW = (255, 255, 0)
...
class Node:
    ...
    # Checked if neighbours are not barriers, if not add the to neighbours list
...
#Get the row and col of the possition clicked
